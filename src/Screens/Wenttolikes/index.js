...
const Wenttolikes = ({ navigation, route }) => {
        ...
        try {
            ...
            if (user == '1') {
                ...
                ApiDataService.Getapi(url).then(response => {
                    setLoading(false);
                    if (response.data.data.my_likes != null || response.data.data.my_likes != '') {
                        var comdata = response.data.data.my_likes;
        ...
        <>
            <View style={{ ...StylesGloble.container, ...StylesGloble.ScreenHorigental, position: "relative" }}>
                ...
                <View style={{ ...StylesGloble.oneline, width: "100%", marginTop: 20 }}>
                    ...
                    <Text style={{ fontSize: 18, fontWeight: "700", color: "#000000", ...StylesGloble.startposition }}>{t('Want to likes')}</Text>
                </View>
                {
                    <FlatList
                        numColumns={3}
